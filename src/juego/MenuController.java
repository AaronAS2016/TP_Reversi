...
public class MenuController extends Application {
	...
	public void start(Stage escenarioPrincipal) throws Exception {
		...
		Parent pantallaPrincipalView = FXMLLoader.load(getClass().getResource(
				"./../views/pantalla-principal.fxml"));

		menu = FXMLLoader.load(getClass().getResource("./../views/menu.fxml"));
		Parent creditos = FXMLLoader.load(getClass().getResource(
				"./../views/creditos.fxml"));
		...
		WindowStyle.stageDimension(escenarioPrincipal.getWidth(),
	...
	public void iniciar() throws IOException {
		...
		TableroController tablero = new TableroController(juego, window,
				pantallaMenu);
		tablero.mostrar();
	}
